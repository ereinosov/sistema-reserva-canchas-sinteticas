/* ============================================================================
   ...
   ARTEFACTO A11: Script DDL (SQL Server)
   ...
   Este es el único script de base de datos del proyecto.
   Ejecutarlo UNA vez en una instancia vacía (SSMS o sqlcmd -I).
   No hay archivos "complemento": TRUSTWORTHY, QUOTED_IDENTIFIER,
   permisos de horarios y procedimientos de usuarios ya van aquí.

   Incluye:
     0. Base de datos y opciones de sesión
     1. Tablas, claves y restricciones
     2. Roles de motor y login de arranque (login_bootstrap)
     3. Índice único filtrado (una reserva activa por franja)
     4. Funciones
     5. Procedimientos (clientes, canchas, usuarios, reservas, pagos, ingresos)
     6. GRANT por rol

   Atención: el script hace DROP TABLE. No volver a ejecutarlo si ya hay datos.
   ============================================================================ */
